    ...
    >
        ...
        >
            {comments.map(comment => {
                ...
                if (!commentData.user || !commentData.comment) return null;
                const user = (props.users || []).find(user => user.id == commentData.user);
                if (!user) return null;
                return <div
                    style={{
                        width: '100%',
