...
import { usePrevious } from '@/app/logic/[id]/hooks/usePrevious';
...
export default function Description(props: {
    ...
    >
        ...
        >
            ...
            >{isLiked && !wasliked ? likesData.length + 1 : likesData.length}</h1>
            ...
            <div style={{ width: '1vw' }} />
            {(user_data && user_data.id == post_data?.userId) ?
                <motion.a
                    href={`/settings/${post_data.id}`}
